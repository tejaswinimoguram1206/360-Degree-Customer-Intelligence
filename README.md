...
Customer Segmentation: Used RFM Analysis and K-Means Clustering to group customers into distinct, actionable personas like "Champions," "At-Risk Customers," and "New Customers."

Customer Churn Prediction: Built a Logistic Regression model to predict the probability of a customer churning (i.e., becoming inactive) based on their behavioral segment and RFM scores.

Customer Lifetime Value (CLV) Prediction: Developed a Random Forest Regressor to predict the future revenue a customer is likely to generate in the next 90 days.

Product Recommendation: Created a simple recommender system using Association Rule Mining (Apriori) to find "if you buy this, you'll also like that" product associations from recent transaction data.
...
The main analysis, model training, and interactive UI are contained in the .ipynb notebook file.
Releases
No releases published
Packages
No packages published
Contributors
https://github.com/tejaswinimoguram1206
